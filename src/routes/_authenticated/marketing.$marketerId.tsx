...
const leadStatuses = [
  ["new", "جديد"], ["contacted", "تم التواصل"], ["qualified", "مؤهل"], ["viewing", "معاينة"], ["negotiation", "تفاوض"], ["won", "صفقة ناجحة — مؤكدة"], ["lost", "غير مكتمل"],
] as const;
